...
# Check if submission is coming from landing.html
is_landing_page = current_page.lower() == "landing.html"

# Extract parameters
logged_in_user_id = extract_user_id(form)

# Resolve Creator Full Name based on user_id (Bypassed for landing.html)
creator_name = "System User"

if is_landing_page:
    # Direct Public Enquiries from landing.html don't require user login
    logged_in_user_id = None
    creator_name = None
    redirect_target = "/techvoltInstituteProject/pages/landing.html"
else:
    # Standard internal user session resolution
